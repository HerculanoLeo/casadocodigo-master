...
public class ProdutoDAO {
	...
	public List<Produto> Relatorio(Calendar calendar) {
		return manager.createQuery(
				"select distinct(p) from Produto p join fetch p.precos precos where p.dataLancamento >= :PdataFiltro",
				Produto.class).setParameter("PdataFiltro", calendar).getResultList();
	}
}